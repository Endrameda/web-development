...
### Context
CC has a [**Context Window**](CC%20-%20Context.md) that determines how much content conversation, files, commands, outputs, etc.  It can store and reference. After it reaches this limit, CC compacts the conversation, automatically deciding what to remove or summarize, to bring the **Context Window** back down to a usable size.
