...
Below have an example prompt that uses all Three elements: 
...
### We can add the Context
For add context we can upload the almost any type of the file, `pdf, doc, json, etc...
